...
export const phaseDistributionFixture = {
  phaseDistribution: [
    ...
    { global_health_area: 'Emerging infectious disease', phase_name: 'Preclinical', sort_order: 12, candidateCount: 205 },
    { global_health_area: 'Emerging infectious disease', phase_name: 'Phase I', sort_order: 30, candidateCount: 111 },
    { global_health_area: 'Emerging infectious disease', phase_name: 'Phase II', sort_order: 40, candidateCount: 88 },
    { global_health_area: 'Emerging infectious disease', phase_name: 'Phase III', sort_order: 50, candidateCount: 85 },
    { global_health_area: 'Emerging infectious disease', phase_name: 'Approved', sort_order: 90, candidateCount: 3 },
    { global_health_area: 'Neglected disease', phase_name: 'Discovery', sort_order: 10, candidateCount: 46 },
    { global_health_area: 'Neglected disease', phase_name: 'Preclinical', sort_order: 12, candidateCount: 183 },
    { global_health_area: 'Neglected disease', phase_name: 'Phase I', sort_order: 30, candidateCount: 154 },
    { global_health_area: 'Neglected disease', phase_name: 'Phase II', sort_order: 40, candidateCount: 135 },
    { global_health_area: 'Neglected disease', phase_name: 'Phase III', sort_order: 50, candidateCount: 47 },
    { global_health_area: 'Neglected disease', phase_name: 'Approved', sort_order: 90, candidateCount: 2 },
    { global_health_area: 'Sexual & reproductive health', phase_name: 'Discovery', sort_order: 10, candidateCount: 38 },
    { global_health_area: 'Sexual & reproductive health', phase_name: 'Preclinical', sort_order: 12, candidateCount: 165 },
    { global_health_area: 'Sexual & reproductive health', phase_name: 'Phase I', sort_order: 30, candidateCount: 120 },
    { global_health_area: 'Sexual & reproductive health', phase_name: 'Phase II', sort_order: 40, candidateCount: 95 },
    { global_health_area: 'Sexual & reproductive health', phase_name: 'Phase III', sort_order: 50, candidateCount: 55 },
    { global_health_area: 'Sexual & reproductive health', phase_name: 'Approved', sort_order: 90, candidateCount: 4 },
  ],
};
...
export const temporalSnapshotsFixture = {
  temporalSnapshots: [
    ...
    { year: 2023, phase_name: 'Preclinical', sort_order: 12, candidateCount: 388 },
    { year: 2023, phase_name: 'Phase I', sort_order: 30, candidateCount: 265 },
    { year: 2023, phase_name: 'Phase II', sort_order: 40, candidateCount: 223 },
    { year: 2023, phase_name: 'Phase III', sort_order: 50, candidateCount: 132 },
    { year: 2023, phase_name: 'Approved', sort_order: 90, candidateCount: 5 },
    { year: 2024, phase_name: 'Discovery', sort_order: 10, candidateCount: 15 },
    { year: 2024, phase_name: 'Preclinical', sort_order: 12, candidateCount: 204 },
    { year: 2024, phase_name: 'Phase I', sort_order: 30, candidateCount: 111 },
    { year: 2024, phase_name: 'Phase II', sort_order: 40, candidateCount: 88 },
    { year: 2024, phase_name: 'Phase III', sort_order: 50, candidateCount: 85 },
    { year: 2024, phase_name: 'Approved', sort_order: 90, candidateCount: 3 },
  ],
};
