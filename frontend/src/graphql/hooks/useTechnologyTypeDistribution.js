...
export function useTechnologyTypeDistribution(globalHealthAreas, diseaseNames, productNames, phaseNames, candidateType) {
  const { actions } = useDashboardStore();
  const cacheKey = getCacheKey('technologyTypeDistribution', { globalHealthAreas, diseaseNames, productNames, phaseNames, candidateType });
