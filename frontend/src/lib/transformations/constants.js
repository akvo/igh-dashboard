...
export const PHASE_COLORS = {
  ...
  'Approved': '#F0B456',
  'Phase IV': '#F0B456',
  'Post-marketing surveillance': '#F0B456',
  'Post-marketing human safety/efficacy studies (without prior clinical studies)': '#F0B456',
  'Human safety & efficacy': '#F0B456',
  'Operational research for diagnostics': '#F0B456',
  'Unclear': '#999999',
