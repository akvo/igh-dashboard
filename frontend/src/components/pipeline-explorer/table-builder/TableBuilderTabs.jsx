...
// =========================================================
// Table Builder — Pipeline Explorer custom-table host
// =========================================================
//
// Ported from app/portfolio-analysis/extract/page.js. Renders the
// four-up sub-tab navigation (Candidates & approved products, R&D
// priorities & candidates, Clinical trials & candidates, R&D
// priorities), a column picker, a server-paginated table, and a CSV
// export. The page chrome — Sidebar, page header, and the global filter
// bar — lives in app/pipeline-explorer/layout.js; this component renders
// only the view body. Filters live inline inside each table card and
// bind the shared global-filter state (gha/primary/secondary/product/
// rdPhase) via useGlobalFilters, so selections persist when toggling to
...
import { Dropdown, DataTable, TabNav } from '@/components/ui';
import {
  CloudDownloadIcon,
  RefreshIcon,
...
// Per-sub-tab heading + description shown in the table card. Replaces
...
export default function TableBuilderTabs() {
  const {
    healthArea,
    primary,
    secondary,
    ...
    <div>
      ...
      <div className="bg-white border border-gray-200">
          ...
          <div className="flex items-start justify-between mb-2">
            <div>
              <h3 className="text-xl font-bold text-black mb-1">
                {TAB_META[extractTab].title}
              </h3>
              <p className="text-sm text-gray-500 mb-4">
                {TAB_META[extractTab].description}
              </p>
        ...
        {/* Per-sub-tab inline filter row.
            GHA + Disease are always visible; Product type appears for the
