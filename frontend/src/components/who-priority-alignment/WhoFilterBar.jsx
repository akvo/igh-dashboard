...
// =========================================================
// Three filters (GHA, hierarchical Disease, Product type) plus a
// Clear button, identical chrome to the Portfolio Analysis
// `GlobalFilterBar`. Internally calls `useWhoPageFilters` so callers
// just render `<WhoFilterBar />` with no props.
