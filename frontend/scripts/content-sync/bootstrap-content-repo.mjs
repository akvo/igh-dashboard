...
// Kept in sync by hand with the live content repo's README.md. If you
// change one, change the other: this template only reaches a freshly
// bootstrapped repo, so drift here is invisible until the next bootstrap.
