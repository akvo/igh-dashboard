...
import { getTemporalSnapshots, getAvailableYears, getTemporalFilterOptions } from "../db/queries/temporal.js";
...
export const resolvers = {
  Query: {
    ...
    // Cross-pipeline temporal filter options
    temporalFilterOptions: () => getTemporalFilterOptions(),
